...
- `lib/event_sales/ingestion/analytics_readiness_resolver.ex`
...
- `EventSales.Analytics.TimeRules` - `lib/event_sales/analytics/time_rules.ex`
  ...
  - uses: _none_
- `EventSales.Analytics.TimeRules.IanaTimeZoneDatabase` - `lib/event_sales/analytics/time_rules.ex`
  - moduledoc?: true
  - specs?: false
  - docs_count: 0
  - public_funs: `time_zone_period_from_utc_iso_days/2`, `time_zone_periods_from_wall_datetime/2`
  - uses: _none_
...
- `EventSales.Ingestion.AdminReconciliationDashboard` - `lib/event_sales/ingestion/admin_reconciliation_dashboard.ex`
  ...
  - uses: _none_
- `EventSales.Ingestion.AnalyticsReadinessResolver` - `lib/event_sales/ingestion/analytics_readiness_resolver.ex`
  - moduledoc?: true
  - specs?: true
  - docs_count: 0
  - public_funs: `resolve/1`
  - uses: _none_
...
- `EventSales.Ingestion.EventStructuralCertifier` - `lib/event_sales/ingestion/event_structural_certifier.ex`
  ...
  - uses: _none_
- `EventSales.Ingestion.FinancialReconciliation.Comparator` - `lib/event_sales/ingestion/financial_reconciliation/comparator.ex`
  - moduledoc?: true
  - specs?: true
  - docs_count: 1
...
- `EventSales.Ingestion.HistoricalCoverageInvalidator` - `lib/event_sales/ingestion/historical_coverage_invalidator.ex`
  ...
  - specs?: true
  - docs_count: 0
  - public_funs: `invalidate_order_change/2`
  - uses: _none_
- `EventSales.Ingestion.HistoricalCoverageResolver` - `lib/event_sales/ingestion/historical_coverage_resolver.ex`
  - moduledoc?: true
  - specs?: true
  - docs_count: 0
  - public_funs: `resolve_current/1`
  - uses: _none_
...
- `EventSales.Ingestion.HistoricalManifestExecution` - `lib/event_sales/ingestion/historical_manifest_execution.ex`
  ...
  - public_funs: `run_step/3`
  - uses: _none_
- `EventSales.Ingestion.HistoricalOrderCoverageCandidateResolver` - `lib/event_sales/ingestion/historical_order_coverage_candidate_resolver.ex`
  - moduledoc?: true
  - specs?: true
  - docs_count: 1
  - public_funs: `resolve/4`
...
- `EventSales.Ingestion.HistoricalOrderMutationDetector` - `lib/event_sales/ingestion/historical_order_mutation_detector.ex`
  ...
  - uses: _none_
- `EventSales.Ingestion.HistoricalRefundCoverageInvalidator` - `lib/event_sales/ingestion/historical_refund_coverage_invalidator.ex`
  - moduledoc?: true
  - specs?: true
  - docs_count: 0
