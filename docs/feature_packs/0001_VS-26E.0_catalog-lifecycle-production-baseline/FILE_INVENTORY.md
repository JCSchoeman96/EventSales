...
Review baseline: `561deaf14a2460e1246c3853c9e595567ace48f8`
...
- `EventSales_VS-26E.0_v1.2.1_561deaf1.zip`
...
## v1.2.1 baseline note

Current `main` is five commits ahead of the original planning baseline. GitHub compare shows no runtime/configuration/migration/test drift, but deployment-on-main means the actual Railway state must be re-proven. The repository now also contains a historical ZIP artefact under `slices/`; do not treat that binary as current execution authority.

Pack-local mandatory file: `PATCH_NOTES.md`.
