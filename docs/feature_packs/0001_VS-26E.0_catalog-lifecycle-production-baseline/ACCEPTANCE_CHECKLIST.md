...
- [ ] Original planning baseline and exact current `main` review baseline recorded.
- [ ] Five-commit drift classified as non-runtime by exact GitHub compare.
...
- [ ] v1.0.0, v1.1.0, and v1.2.0 recorded as superseded for activation; v1.1.0 and v1.2.0 retained as historical evidence.
- [ ] v1.2.1 source, ZIP and SHA registered remotely before activation.
- [ ] PR #117 remains open/unmerged as historical evidence; no pack PR is merged merely to enable planning.
...
- [ ] Current `main` Railway failure status recorded and diagnosed.
- [ ] Actual active deployed commit identified independently of GitHub `main`.
...
- [ ] Maximum aggregate row bound calculated from current config.
- [ ] Full-feed row/page count and observed duration recorded.
- [ ] No p50/p95 claim made from a single certification run.
- [ ] Finding message/metadata observed sizes recorded; no false database-bound claim made.
...
- [ ] Exact successor certificate fields completed.
- [ ] Patched pack source/ZIP/SHA registered in GitHub and Linear.
