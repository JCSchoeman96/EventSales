defmodule EventSalesWeb.Components.Alert do
  @moduledoc """
  EventSalesWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
