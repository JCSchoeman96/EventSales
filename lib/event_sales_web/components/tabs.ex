defmodule EventSalesWeb.Components.Tabs do
  @moduledoc """
  `EventSalesWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import EventSalesWeb.Components.Badge, only: [badge: 1]
