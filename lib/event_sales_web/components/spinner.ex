defmodule EventSalesWeb.Components.Spinner do
  @moduledoc """
  The `EventSalesWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `EventSalesWeb.Components.Spinner` module enables developers to provide
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/spinner
  ...
  use Gettext, backend: EventSalesWeb.Gettext
