defmodule EventSalesWeb.Components.Divider do
  @moduledoc """
  The `EventSalesWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/divider
  ...
  import EventSalesWeb.Components.Icon, only: [icon: 1]
  ...
  @doc """
  `EventSalesWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
